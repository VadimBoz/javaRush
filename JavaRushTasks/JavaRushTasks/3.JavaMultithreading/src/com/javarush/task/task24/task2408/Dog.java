        ...
        class DogPet extends SuperDog implements Sayable {
            ...
            public String say() {
                if (i < 1)
                    ...
                    String sayStr = Stream.generate((() -> "а")).limit(i).collect(Collectors.joining());
                    Date d = new Date();
                    SimpleDateFormat simpleDateFormat = super.formatter;
                    String dataStr = simpleDateFormat.format(d);
                    return getName() + " лает г" + sayStr + "в! " +  dataStr;
                }
            }
        }
